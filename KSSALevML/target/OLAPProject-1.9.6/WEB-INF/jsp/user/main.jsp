...
<div class="container-fluid olap-background-img" style="height:87%">
	<div class="row">
		<div class="col-12">
			<div class="row justify-content-md-end">
				<div class="m-3">
					<div class="d-flex justify-content-start">
						<img src="<c:url value='/images/common/ci/ksm_icon.png'/>" alt="ksm" class="my-0 img-fluid head-ci-img" >
					</div>
					<div class="col-12 h4">
