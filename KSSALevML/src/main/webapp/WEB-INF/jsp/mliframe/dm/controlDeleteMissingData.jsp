...
<script>
	...
	$(document).ready(function() {
		...
		$('#dataSubmitBtn').click(function(e){
			...
			var abnum = $('#input_abnormal_number').val();
			var abstr = $('#input_abnormal_string').val();
			var evchk = $('#check_empty_value').is(":checked");
			var nanchk = $('#check_nan_value').is(":checked");
			if(abnum.length==0 && abstr.length==0 && !nanchk){
				$('#check_empty_value').prop("checked",true);
				evchk=true;
			}
			...
			$.doPost({
				url : "/mliframe/deleteMissingData.do",
				data : param,
				success : function(data){
	...
	<div class="col-3 card mr-10" id="div_control">
		...
		<div class="card-title mb-0">
			<div class="row">
				<div class="col">
					<p class="h5 mb-1">
						<label class="mliFrame-name" id="label_remove_value"><strong>Remove Value</strong></label>
					</p>
				</div>
			</div>
		</div>
		<div class="form-group">
			<div>
				<input type="checkbox" id="check_empty_value" name="remove_value" style="margin-right:2px;vertical-align: middle;">
				<span id="span_empty_value" style="vertical-align: middle;">Empty</span>
				<input type="checkbox" id="check_nan_value" name="remove_value" style="margin-right:2px;vertical-align: middle;">
				<span id="span_nan_value"style="vertical-align: middle;">NaN</span>
			</div>
		</div>
		<div class="card-title mb-0">
			<div class="row">
				<div class="col">
					<p class="h5 mb-1">
						<label class="mliFrame-name" id="label_abnormal_number"><strong>Abnormal Number</strong></label>
					</p>
				</div>
			</div>
		</div>		
		<div class="form-group">
			<input type="text" class="form-control-text" id="input_abnormal_number" name="abnormal_number" />
		</div>
		<div class="card-title mb-0">
			<div class="row">
				<div class="col">
					<p class="h5 mb-1">
						<label class="mliFrame-name" id="label_abnormal_string"><strong>Abnormal String</strong></label>
					</p>
				</div>
			</div>
		</div>		
		<div class="form-group">
			<input type="text" class="form-control-text" id="input_abnormal_string" name="abnormal_string" />
		</div>
	</div>
