...
<div class="col-md-12 col-lg-12 col-xl-12 col-12 ml-auto mr-auto px-4">	
	<div class="row">
		...
		<div class="col-6 ">
			<div class="h6 form-inline d-flex justify-content-end" style="min-height:80px;">&nbsp;&nbsp;
			<strong><i class="fas fa-info-circle"></i>
			<span class="ml-1">스케줄 정보</span>
			</strong>&nbsp;&nbsp;
				<label for="startDate">Start Date:</label>
				<input type="text" name="startDate" id="startDate" class="datePicker ml-2" style="width:120px;" />&nbsp;&nbsp;
				<label for="endDate">End Date:</label>
				<input type="text" name="endDate" id="endDate" class="datePicker ml-2" style="width:120px;" />
				<select id="batchPlayType" class="form-control form-control-sm ml-3" >
					<option value="TOTAL" selected>전체 과정 구동</option>
					<option value="ONLY_ORG_ETL_ML">ORG데이터 이관&ML 학습만</option>
					<option value="ONLY_AS_ETL">AS 이력 데이터 이관 및 집계만</option>
				</select>
			</div>
		...
		<div class="col-12 pt-5">
			...
			<div class="d-flex justify-content-end bd-highlight align-items-center">
...
<div id="failDetailPopup" class="modal" tabindex="-1">
  <div class="modal-dialog modal-xl modal-dialog-scrollable">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title"><strong>배치 실패 상세 메시지</strong></h5>
      ...
      <div class="overflow-auto">
      	<pre id="failDetailMsg" class="custom-error-textarea"></pre>
      </div>
      </div>
...
function batchStart(){
	...
	let flag = $("#batchPlayType").val();
	
		batchAction.startAction(startDate,endDate,flag);
 	  /* $.ajax({
				type : "GET",
