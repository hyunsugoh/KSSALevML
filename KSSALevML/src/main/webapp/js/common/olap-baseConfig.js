...
var OlapUrlConfig = {
		...
		selectASHistoryGridData : OLAPBaseUrl + "/user/api/data/selectASHistoryGridData.do",
		...
		excelUploadProcessConf : OLAPBaseUrl + "/admin/api/confExcel.do", //코드 엑셀 업로드 확인
		selConfExcel : OLAPBaseUrl + "/admin/api/selConfExcel.do", //코드 엑셀 업로드 확인조회
		savInfoProcess : OLAPBaseUrl + "/admin/api/savInfoProcess.do", //엑셀 업로드 저장
		...
		// project
		getSubProjectContents : OLAPBaseUrl + "/project/getSubProjectContents.do"
};
