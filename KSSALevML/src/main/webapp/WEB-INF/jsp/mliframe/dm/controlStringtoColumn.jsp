...
<script>
	...
	$(document).ready(function() {
		...
		$('#dataSubmitBtn').click(function(e){
			...
			var sptSize = $('#input_split_size').val();
			if(sptSize.length==0){
				alert('Split Size를 체크해 주세요.');
				return;
			}
			...
			$.doPost({
				url : "/mliframe/stringToColumn.do",
				data : param,
				success : function(data){
	...
	<div class="col-3 card mr-10" id="div_control">
		...
		<div class="card-title mb-0">
			<div class="row">
				<div class="col">
					<p class="h5 mb-1">
						<label class="mliFrame-name required" id="label_split_size"><strong>Split Size</strong></label>
					</p>
				</div>
			</div>
		</div>		
		<div class="form-group">
			<input type="text" class="form-control-number" id="input_split_size" name="split_size" />
		</div>
	</div>
