	...
	$(document).ready(function() {
		...
		$('#dataSubmitBtn').click(function(e){
			...
			for(var i=0;i<chkData.length;i++){
				inputcols.push(chkData[i].data.COL_NAME);
			}
			...
			var sorttype = $('#select_sort_type').val();
			...
			$.doPost({
				url : "/mliframe/sort.do",
				data : param,
				success : function(data){
					cfn_createCommonDataGrid("targetGrid",cols,data.list);
		...
		<div class="card">
	  	...
	  	<div class="card-title mb-0">
			<div class="row">
				<div class="col">
					<p class="h5 mb-1">
						<label class="mliFrame-name required" id="label_sort_type"><strong>Sort Type</strong></label>
					</p>
				</div>
			</div>
		</div>		
		<div class="form-group">
			<select class="form-control form-control-sm" data-width="200px" id="select_sort_type" name="sort_type">
