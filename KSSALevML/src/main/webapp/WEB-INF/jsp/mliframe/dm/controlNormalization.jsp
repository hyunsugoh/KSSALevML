...
<script>
	...
	$(document).ready(function() {
		...
		$('#dataSubmitBtn').click(function(e){
			...
			var normtype = $('#select_normalization_type').val();
		...
		<div class="card">
	  	...
	  	<div class="card-title mb-0">
			<div class="row">
				<div class="col">
					<p class="h5 mb-1">
						<label class="mliFrame-name required" id="label_normalization_type"><strong>Normalization Type</strong></label>
					</p>
				</div>
			</div>
		</div>		
		<div class="form-group">
			<select class="form-control form-control-sm" data-width="200px" id="select_normalization_type" name="normalization_type">
