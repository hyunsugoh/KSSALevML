...
$(document).ready(function() {
	...
	$.doPost({
		...
		success : function(data){
			...
			//changeSelectOpt(data.cols.map(x => x.COL_NAME));
		},
	...
	$("#dataSubmitBtn").click(function(e) {
		...
		var param = {
				...
				col			: $("#input_col").val(),			// 다시 하나로 합칠 col명
				val			: $("#input_val").val(), 			// value 컬럼헤더명
	  	...
	  	<div class="container pr-1 pl-1">
			...
			<div class="card-title mb-0">
				<div class="row">
					<div class="col">
						<p class="h5 mb-1">
							<strong class="mliFrame-name">기준 컬럼명</strong>
						</p>
					</div>
				</div>
			</div>		
			<div class="form-group">
				<input type="text" class="form-control-text" id="input_col">
			</div>
			...
			<div class="card-title mb-0">
				<div class="row">
					<div class="col">
						<p class="h5 mb-1">
							<strong class="mliFrame-name">Value 컬럼명</strong>
						</p>
					</div>
				</div>
			</div>		
			<div class="form-group">
				<input type="text" class="form-control-text" id="input_val">
			</div>
