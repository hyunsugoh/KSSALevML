		...
		<div class="col-12 pt-3">
			<div class="row">
				...
				<div class="col-12 mt-3">
					<p class="text-muted custom-muted-size"><em>데이터 조회 페이지의 컬럼(항목)을 노출 제어를 할 수 있는 객체 관리 페이지입니다. 해당 페이지에서 수정/삭제를 진행할 경우 데이터 조회 페이지가 영향을 받게 되니 관리자 외에는 수정하지 마십시오.</em></p>
				</div> 
			</div>
		</div>
...
<!-- 					<button type="button" class="btn btn-outline-primary" onclick="active();"> -->
<!-- 						활성화/비활성화 <i class="fab fa-creative-commons-sa"></i> -->
<!-- 					</button> -->
<!-- 					<button type="button" class="btn btn-outline-success" data-toggle="modal" data-target="#myModal" onclick="addPopup();"> -->
