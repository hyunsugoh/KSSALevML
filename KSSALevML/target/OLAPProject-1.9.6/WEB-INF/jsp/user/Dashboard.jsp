...
$(document).ready(function() {
	...
	// 기본정보 가져오기
	olapDataView.init("objectViewGrid", "externalPager");
					...
					<div class="col-lg-12 col-xl-8 mt-xs-9 mt-sm-9 mt-md-9 mt-lg-0">
						<div class="card custom-search-card-div-height">
							<div class="col-12">
								...
								<div id="conditionArea" class="scroll-height-fix-two card"
									style="height: 120px;">
									<div
								...
								<div class="pt-3">
									<div class="d-flex justify-content-end">
										<button id="clearCondBtn" class="btn btn-sm btn-outline-primary mr-3">초기화 하기</button>
										<button id="dataSubmitBtn" class="btn btn-sm btn-primary">조회하기</button>
  ...
  <div class="modal-dialog modal-lg" role="document"  style="max-width:1400px;">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body mb-0 p-0">
        <!--Google map-->
        <div id="map-container-google-2" class="z-depth-1-half map-container" style="height: 530px">
