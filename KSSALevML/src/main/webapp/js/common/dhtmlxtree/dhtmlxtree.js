...
function dhtmlXTreeObject(htmlObject, width, height, rootId){
  if (dhtmlxEvent.initTouch)
   ...
   this.imageArray=new Array("folderClosed.gif","folderOpen.gif","folderClosed.gif");
...
dhtmlXTreeObject.prototype._createItem=function(acheck,itemObject,mode){
	...
	else
	{
        ...
        itemObject.span.style.paddingLeft="5px";      itemObject.span.style.paddingRight="5px";
        itemObject.span.style.paddingBottom="5px";      itemObject.span.style.paddingTop="5px";
