...
<!-- 			</li> -->
			<li class="nav-item">
				<a id="adminMLGroupInfo_menu_btn_m" class="nav-link d-block d-md-none" data-toggle="tooltip" data-placement="bottom" title="ML 그룹 정보" href="<c:url value='/admin/adminMLGroupInfo.do'/>"> 
					<i class="far fa-2x fa-object-group admin-right-menu-md-icon"></i>
				</a> 
				<a id="adminMLGroupInfo_menu_btn_pc" class="nav-link d-none d-md-block" href="<c:url value='/admin/adminMLGroupInfo.do'/>"> 
					<i class="far fa-object-group "></i> ML 그룹 정보
				</a>
			</li>
