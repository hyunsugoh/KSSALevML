	...
	$(document).ready(function() {
		...
		*/
		$('#dataSubmitBtn').click(function(e){
			...
			// 0 < min_weight_fraction_leaf < 0.5 
			if(trainParam.algparam.min_weight_fraction_leaf < 0
					|| trainParam.algparam.min_weight_fraction_leaf > 5 ) {
				alert('min_weight_fraction_leaf는 0과 0.5 사이의 값이어야 합니다.');
				return;
			} 
	  	...
	  	<div class="container pr-1 pl-1">
			...
			<div class="card-title mb-0">
				<div class="row">
					<div class="col">
						<p class="h5 mb-1">
							<strong class="mliFrame-name">Splitter</strong>
						</p>
					</div>
				</div>
			</div>		
			<div class="form-group">
				<select class="form-control form-control-sm" data-width="200px" id="select_splitter">
			...
			<div class="form-group">
				<input type="text" class="form-control-number" id="input_min_impurity_split" value="0">
			</div>
