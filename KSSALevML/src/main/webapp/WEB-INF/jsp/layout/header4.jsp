...
<script src="<c:url value='/js/common/jquery.ajax-cross-origin.min.js'/>"></script>

<link rel="stylesheet" type="text/css" href="<c:url value='/css/joint/joint.css'/>" />
<link rel="stylesheet" type="text/css" href="<c:url value='/css/common/mliframe-common.css'/>" />
...
<link rel="stylesheet" type="text/css" href="<c:url value='/css/common/bootstrap/bootstrap.css'/>">
...
<link rel="stylesheet" href="<c:url value='/css/common/olap-common2.css'/>">
