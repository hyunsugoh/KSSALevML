	  	...
	  	<div class="container pr-1 pl-1">
			...
			<div class="form-group">
				<select class="form-control form-control-sm" data-width="200px" id="select_objective">
					...
					<option value="binary:hinge">binary:hinge</option>
					<option value="multi:softmax">multi:softmax</option>
					<option value="multi:softprob">multi:softprob</option>
				</select>
			</div>
			...
			<div class="form-group">
				<input type="text" class="form-control-number" id="scale_pos_weight" value="1">
			</div>
			...
			<div class="form-group">
				<input type="text" class="form-control-number" id="scale_base_score" value="0.5">
			</div>
			...
			<div class="form-group">
				<input type="text" class="form-control-number" id="scale_num_parallel_tree" value="1" step="1">
			</div>
