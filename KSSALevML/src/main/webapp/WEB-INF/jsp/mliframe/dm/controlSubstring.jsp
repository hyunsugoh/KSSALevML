...
<script>
	...
	$(document).ready(function() {
		...
		$('#dataSubmitBtn').click(function(e){
			...
			var stIdx = $('#input_start_index').val();
			var sbtSize = $('#input_substring_size').val();
			if(chkData.length==0){
				alert('칼럼을 체크해 주세요.');
				return;
			}
	...
	<div class="col-3 card mr-10" id="div_control">
		...
		<div class="card-title mb-0">
			<div class="row">
				<div class="col">
					<p class="h5 mb-1">
						<label class="mliFrame-name" id="label_start_index"><strong>Start Index</strong></label>
					</p>
				</div>
			</div>
		</div>		
		<div class="form-group">
			<input type="text" class="form-control-number" id="input_start_index" name="start_index" />
		</div>
		<div class="card-title mb-0">
			<div class="row">
				<div class="col">
					<p class="h5 mb-1">
						<label class="mliFrame-name" id="label_substring_size"><strong>Substring Size</strong></label>
					</p>
				</div>
			</div>
		</div>		
		<div class="form-group">
			<input type="text" class="form-control-number" id="input_substring_size" name="substring_size" />
		</div>
	</div>
